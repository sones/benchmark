...
# 
# This is the run script for sones GraphDB Benchmark Tool
# 
...
#
echo "sones GraphDB Benchmark (C) sones GmbH 2011";
echo "";
...
if [ $option == "-r" ]; then
	echo "Starting sones GraphDB Benchmark (RELEASE) in $DIRECTORY/GraphDBBenchmark/bin/Release/";
	echo "";
	cd $DIRECTORY/GraphDBBenchmark/bin/Release/
...
#	 		fi
	...
	echo "Starting sones GraphDB Benchmark (DEBUG) in $DIRECTORY/GraphDBBenchmark/bin/Debug/";
	echo "";
